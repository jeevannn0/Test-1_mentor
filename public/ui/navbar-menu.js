...
export const Menu = ({ setActive, children }) => {
  return (
    <nav
      ...
      className="relative rounded-full border border-transparent dark:bg-black dark:border-black bg-white shadow-input flex justify-center space-x-4 px-8 py-6 "
    >
      {children}
    </nav>
  );
  ...
  return (
    <Link href={href} className="flex space-x-2">
      ...
      <div>
        ...
        <p className="text-white text-sm max-w-[10rem] dark:text-black">
          {description}
        </p>
      </div>
    </Link>
