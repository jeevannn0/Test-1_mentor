    ...
    <Link href="/components/pages/signup">
      ...
      <section className="w-full py-12 md:py-24 lg:py-32">
        <div className="container space-y-12 px-4 md:px-6">
          ...
          <div
            className="mx-auto grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3 lg:max-w-5xl">
            <Card>
              <CardHeader>
                <img
                  src="/placeholder.svg"
      ...
      <footer
        className="px-4 lg:px-6 h-14 flex items-center justify-between bg-background border-t">
