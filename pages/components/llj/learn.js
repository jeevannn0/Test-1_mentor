...
import Progms from "./learn/progms";
import Footer from "../main/footer";
import Prt1 from "./learn/part1";
import Prt2 from "./learn/part2";
import Prt3 from "./learn/part3";
...
<header className="px-4 lg:px-6 h-14  bg-background border-b flex items-center justify-center">
      ...
      <h1 className="text-4xl font-bold text-center text-primary">LEARN</h1> {/* Reduced font size */}
   ...
   <Progms/>
    ...
    <div className="flex items-center justify-between mt-20 p-8 bg-[#2f2462] rounded-lg ">
